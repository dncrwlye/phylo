#dan crowley
#12/01/2019: attempt to run hnv factorization again
#updated with new data 
#ignores sampling effort 

#01/02/2019: trying this again
#this does not ignore sampling effort, was i paying attention at all?
...
save(list=ls(),file='/Users/buckcrowley/phylofactor_paper/data/phylofactor work spaces/hnv_workspace_SE')
